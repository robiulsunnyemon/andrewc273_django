...
class CaseSubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'case_title', 'case_number', 'author', 'press_release', 'state', 'federal_district', 'court_type', 'is_anonymous', 'press_release_enhanced', 'ai_analysis_summary', 'created_at']
