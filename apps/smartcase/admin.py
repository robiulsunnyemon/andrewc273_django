...
class CaseSubmissionAdmin(ModelAdmin):
    list_display = ('id', 'user', 'case_title', 'case_number', 'author', 'state','press_release_enhanced','ai_analysis_summary','created_at')
    search_fields = ('case_title', 'case_number', 'author', 'state')
